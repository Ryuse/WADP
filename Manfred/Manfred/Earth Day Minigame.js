...
function gameOver() {
    //var name = prompt("Game over! Your score: " + myGameArea.frameNo + "\nPlease enter your name.");
	//if (name == "") {
		//var name = prompt("Please enter a name to continue.")
	//}
	var a = confirm("Congratulations, " + name + ", your score is " + myGameArea.frameNo + "!\nWould you like to return to the main menu?");		
